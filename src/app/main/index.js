...
const { store } = require("../../system/server/api/store/global.js")
const {logger } = require("../../system/server/api/controllers/logger.js")
...
var menu = Menu.buildFromTemplate([
  ...
  },
  {
    ...
    submenu: [
      {
        label: 'Open Logs',
        click() { shell.openPath(store.system.logFolder )  }
      },
      {
