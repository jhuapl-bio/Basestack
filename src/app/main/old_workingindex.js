...
const logger  = require("../../shared/logger.js").logger(path.join(store.system.logPath, 'system.log'), path.join(store.system.logPath, "errorsystem.log"))
...
var menu = Menu.buildFromTemplate([
  ...
  },
  {
    ...
    submenu: [
      {
        label: 'Open Logs',
        click() { console.log(); //shell.openPath(store.meta.logFolder)  
        }
      },
      {
