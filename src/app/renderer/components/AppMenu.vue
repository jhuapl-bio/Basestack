  ...
  >
    ...
    >
      <div
        ...
        class="w-full px-4 pt-6 hide-scrollbar"
    ...
    <section
      ...
      :class="[
        showAllModules
          ...
          : 'opacity-100 row-span-3 scale-100',
      ]"
    >
      <div
        v-for="(view, index) in views"
        :key="index"
        class="grid p-2 place-items-center"
      >
...
export default {
  ...
  computed: {
    moduleContainerHeight: function () {
      ...
      return this.showAllModules ? "100%" : 3 * moduleHeight + "px";
    },
  },
